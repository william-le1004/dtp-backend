...
namespace Application.Features.Tour.Commands
{
    ...
    public class DeleteTourScheduleHandler : IRequestHandler<DeleteTourScheduleCommand, ApiResponse<string>>
    {
        ...
        public async Task<ApiResponse<string>> Handle(DeleteTourScheduleCommand request,
            CancellationToken cancellationToken)
        {
            ...
            return ApiResponse<string>.SuccessResult("Tour schedules and associated tickets deleted successfully",
                "Deletion successful");
        }
    }
}